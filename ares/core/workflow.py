    ...
    def _eval_element_workflow(self) -> None:
        ...
        try:
            for wf_element_name, wf_element in self.workflow.items():
                ...
                elif hasattr(wf_element, "input") and wf_element.input is not None:
