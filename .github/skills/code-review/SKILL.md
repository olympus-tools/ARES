...
- [python](../../instructions/coding-python.instructions.md)
...
**File Naming**: `code-review-<branch-name>.md`
...
**References**:
- [Python Best Practices](../../instructions/coding-python.instructions.md)
...
Save the review results to a file named `code-review-<branch-name>.md`:
...
- **code-review Skill Version**: [link to commit]
- **Best Practices Referenced**:
  - [ARES README](../../../README.md)
  - [ARES python instructions](../../instructions/coding-python.instructions.md)
